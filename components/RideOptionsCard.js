  ...
  return (
    <SafeAreaView style={tw`bg-white flex-grow`}>
      <View>
        ...
        <Text style={tw`text-center py-5 text-xl font-normal`}>
      ...
      <View>
        <TouchableOpacity
          disabled={!selected}
          style={tw`bg-green-500 py-2  mb-10 mt-2 rounded ${
            !selected && "bg-gray-300"
          }`}
        >
          <Text
            style={tw`font-semibold text-center text-white text-xl text-black`}
          >
